...
Autopilot::
    The autopilot is a recommendation engine for Lightning Network nodes that uses statistics of the known network topology to suggest nodes with whom they should open channels.
    Depending on the implementation of the autopilot, a channel's capacity may also be recommended.
